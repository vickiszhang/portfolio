  ...
  return (
    <div className="main" id="experience">
      ...
      <div className="experience">
        ...
        />
        <JobCard
          title="Software Developer • Thrive Health"
        ...
        />
        <JobCard
          title="Full Stack Developer • Public Health Agency of Canada"
        ...
        />
        <JobCard
          title="Software Developer • UBC Computer Science Student Society"
        ...
        />
        <JobCard
          title="AI/ML Engineer • Convergence"
